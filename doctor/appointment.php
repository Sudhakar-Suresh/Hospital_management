...
<body>
    ...
    <div class="container">
        ...
        <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-prescribe ">
                        <a href="prescribe.php" class="non-style-link-menu "><div><p class="menu-text">Prescription</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr >
                                        ...
                                        &nbsp;&nbsp;&nbsp;
                                        <a href="?action=prescription&id='.$appoid.'&name='.$pname.'&session='.$title.'&apponum='.$apponum.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-prescription"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Prescription</font></button></a>
                                        &nbsp;&nbsp;&nbsp;
                                        </div>
                                        </td>
                ...
                <center>
                    ...
                    <div class="content">
                        ...
                        <form action="save-prescription.php" method="post">
                            ...
                            <textarea name="prescription" rows="10" cols="50" class="input-text" placeholder="Write the prescription here" required></textarea><br><br>
                            <input type="submit" value="Save Prescription" class="btn-primary btn">
                        </form>
                    </div>
                </center>
            </div>
